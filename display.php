            ...
            <tbody>
                ...
                while ($row = pg_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <button class="btn2"><a href="delete.php?deleteid='.$id.'" title="Deletar"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#1a89c9" class="bi bi-trash" viewBox="0 0 16 16">
